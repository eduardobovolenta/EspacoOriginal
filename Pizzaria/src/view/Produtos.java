...
//
//        for (Bebida b : bebida.readBebida()) {
//            modelo.addRow(new Object[]{
//                b.getId(),
//                b.getNome(),
//                b.getIngredientes(),
...
//    }
//
//    public void readJTableForNomeBebida(String nome) {
//        DefaultTableModel modelo = (DefaultTableModel) jTProdutos1.getModel();
//        modelo.setNumRows(0);
//        BebidaDAO dao = new BebidaDAO();
//
//        for (Bebida b : dao.readForNomeBebida(nome)) {
//
//            modelo.addRow(new Object[]{
//                b.getId(),
//                b.getNome(),
...
//    }
//
//    public void readJTablePorcao() {
//        DefaultTableModel modelo = (DefaultTableModel) jTProdutos2.getModel();
//        modelo.setNumRows(0);
//
//        PorcoesDAO porcao = new PorcoesDAO();
//
//        for (Porcao po : porcao.readPorcao()) {
//            modelo.addRow(new Object[]{
//                po.getId(),
//                po.getNome(),
//                po.getIngredientes(),
...
//    }
//
//    public void readJTableForNomePorcao(String nome) {
//        DefaultTableModel modelo = (DefaultTableModel) jTProdutos2.getModel();
//        modelo.setNumRows(0);
//        PorcoesDAO dao = new PorcoesDAO();
//
//        for (Porcao po : dao.readForNomePorcao(nome)) {
//
//            modelo.addRow(new Object[]{
//                po.getId(),
//                po.getNome(),
...
//    }
//
//    public void readJTableSobremesa() {
//        DefaultTableModel modelo = (DefaultTableModel) jTProdutos3.getModel();
//        modelo.setNumRows(0);
//
//        SobremesaDAO sobremesa = new SobremesaDAO();
//
//        for (Sobremesa s : sobremesa.readSobremesa()) {
//            modelo.addRow(new Object[]{
//                s.getId(),
//                s.getNome(),
//                s.getIngredientes(),
...
//    }
//
//    public void readJTableForNomeSobremesa(String nome) {
//        DefaultTableModel modelo = (DefaultTableModel) jTProdutos3.getModel();
//        modelo.setNumRows(0);
//        SobremesaDAO dao = new SobremesaDAO();
//
//        for (Sobremesa s : dao.readForNomeSobremesa(nome)) {
//
//            modelo.addRow(new Object[]{
//                s.getId(),
//                s.getNome(),
...
//    }
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(908, 696));
        ...
        panelPizzaLayout.setHorizontalGroup(
            ...
            .addGroup(panelPizzaLayout.createSequentialGroup()
                ...
                .addGroup(panelPizzaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panelPizzaLayout.createSequentialGroup()
                        .addComponent(btnCadastrarPizza, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(btnExcluirPizza, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(btnAtualizarPizza, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(12, 12, 12)
                        .addComponent(txtBuscarPizza, javax.swing.GroupLayout.PREFERRED_SIZE, 267, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelPizzaLayout.createSequentialGroup()
                ...
                .addGroup(panelPizzaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(panelPizzaLayout.createSequentialGroup()
                        ...
                        .addComponent(txtBuscarPizza, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(btnBuscarPizza, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(btnAtualizarPizza, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(btnExcluirPizza, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(btnCadastrarPizza, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        panelBebidasLayout.setHorizontalGroup(
            ...
            .addGroup(panelBebidasLayout.createSequentialGroup()
                .addGroup(panelBebidasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panelBebidasLayout.createSequentialGroup()
                        .addComponent(btnCadastrarBebida, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(btnExcluirBebida, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(btnAtualizarBebida, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(22, 22, 22)
                        .addComponent(txtBuscarBebida, javax.swing.GroupLayout.PREFERRED_SIZE, 267, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(btnBuscarBebida, javax.swing.GroupLayout.PREFERRED_SIZE, 86, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        panelBebidasLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelBebidasLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(panelBebidasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(panelBebidasLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(btnCadastrarBebida, javax.swing.GroupLayout.DEFAULT_SIZE, 42, Short.MAX_VALUE)
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, panelBebidasLayout.createSequentialGroup()
                            .addGap(0, 0, Short.MAX_VALUE)
                            .addComponent(txtBuscarBebida, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addComponent(btnBuscarBebida, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(btnAtualizarBebida, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addComponent(btnExcluirBebida, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        panelPorcaoLayout.setHorizontalGroup(
            ...
            .addGroup(panelPorcaoLayout.createSequentialGroup()
                .addGroup(panelPorcaoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panelPorcaoLayout.createSequentialGroup()
                        .addComponent(btnCadastrarPorcao, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(btnExcluirPorcao, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(btnAtualizarPorcao, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(22, 22, 22)
                        .addComponent(txtBuscarPorcao, javax.swing.GroupLayout.PREFERRED_SIZE, 267, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        panelPorcaoLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelPorcaoLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(panelPorcaoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(btnCadastrarPorcao, javax.swing.GroupLayout.DEFAULT_SIZE, 42, Short.MAX_VALUE)
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, panelPorcaoLayout.createSequentialGroup()
                        .addGap(0, 0, Short.MAX_VALUE)
                        .addGroup(panelPorcaoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtBuscarPorcao, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(btnExcluirPorcao, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addComponent(btnAtualizarPorcao, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(panelSobremesaLayout.createSequentialGroup()
                .addGroup(panelSobremesaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panelSobremesaLayout.createSequentialGroup()
                        ...
                        .addGap(22, 22, 22)
                        .addComponent(txtBuscarSobremesa, javax.swing.GroupLayout.PREFERRED_SIZE, 267, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        panelSobremesaLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelSobremesaLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(panelSobremesaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(btnAtualizarSobremesa, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnBuscarPizzaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarPizzaActionPerformed
        // TODO add your handling code here:
        readForNome(txtBuscarPizza.getText());
    ...
    private void btnBuscarBebidaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarBebidaActionPerformed
        // TODO add your handling code here:
//        readJTableForNomeBebida(txtBuscarBebida.getText());
    ...
    private void btnBuscarPorcaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarPorcaoActionPerformed
        // TODO add your handling code here:
//        readJTableForNomePorcao(txtBuscarPorcao.getText());
    ...
    private void btnBuscarSobremesaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarSobremesaActionPerformed
        // TODO add your handling code here:
//        readJTableForNomeSobremesa(txtBuscarSobremesa.getText());
