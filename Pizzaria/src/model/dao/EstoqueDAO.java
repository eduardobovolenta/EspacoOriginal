...
public class EstoqueDAO {
    ...
    public void create(Estoque e) {
        ...
        try {
            stmt = con.prepareStatement("INSERT INTO estoque (id, nome,quantidade,data)VALUES (default, ?,?,?)");
    ...
    public void update(Estoque e) {
        ...
        try {
            stmt = con.prepareStatement("UPDATE estoque SET nome = ? ,quantidade = ?,data = ? WHERE id = ?");
            stmt.setString(1, e.getNome());
            stmt.setInt(2, e.getQuantidade());
            stmt.setString(3, e.getData());
